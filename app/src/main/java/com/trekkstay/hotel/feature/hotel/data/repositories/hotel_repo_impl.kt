...
class HotelRepoImpl(private val remoteDataSource: HotelRemoteDataSource) : HotelRepo {
    ...
    override suspend fun updateHotel(
        ...
        return when (val response = remoteDataSource.updateHotel(
            name,
            description,
            airportTransfer,
            conferenceRoom,
    ...
    override suspend fun viewHotel(
        ...
        return when (val response =
            remoteDataSource.viewHotel(name, provinceCode, districtCode, wardCode, priceOrder)) {
            is Response.Success -> response.data!!.right()
            is Response.Invalid -> ApiInvalid(
                response.message ?: "Unknown error",
                response.status ?: "-1"
    ...
    override suspend fun searchHotel(
        ...
        return when (val response = remoteDataSource.searchHotel(
            locationCode,
            attractionLat,
            attractionLng,
            attractionName,
